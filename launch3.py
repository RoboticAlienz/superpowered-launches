...
def main_v3():
    ...
    motors.move(1370, 'degrees', speed=80)
    # turn left
    ...
    #pid_yaw_angle(-89, 300, speed=60)
    #motors.move(350, 'degrees', speed=90)
    #motors.move(80, 'degrees', speed=90)
    #motors.move(100, 'degrees', speed=-90)
    #gyro_turn(-65, -50, False, False)
    #motors.move(200, 'degrees', speed=60)
    #motors.move(100, 'degrees', speed=-50)
    #gyro_turn(-140, 40, True, True)
    #motors.move(1800, 'degrees', speed=60)
    # turn right
    gyro_turn(-70, 50, True, False)
    # move forward energy units
    motors.move(370, 'degrees', speed=90)
    gyro_turn(0, 40, True, True)
    motors.move(300, 'degrees', speed=90)
    # move forward energy units
    motors.move(350, 'degrees', speed=-80)
    gyro_turn(-90, 50, False, False)
    motors.move(540, 'degrees', speed=90)
